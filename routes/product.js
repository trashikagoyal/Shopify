...
const {showAllProducts, productForm , createProduct , showProduct , editProductForm , updateProduct , deleteProduct, shareProduct} =  require('../controllers/product')
...
router.get('/products/:id/share', isLoggedIn, shareProduct);
